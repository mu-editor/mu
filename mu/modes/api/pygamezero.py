...
PYGAMEZERO_APIS = {
    'en_US': [
        ...
        _(  "actor.scale \nSet a scale of the Actor image."  ),
        _(  "actor.say_for_sec(text, second, fgcolor=None, bgcolor=None) \nDisplay text on the Actor image during second."  ),
    ],
    'uz_UZ': [
        _(
            "actor.Actor(image, pos=None, anchor=None, **kwargs) \nRect(left, top, width, height) -> Rect\nRect((left, top), (width, height)) -> Rect\nRect(object) -> Rect\nPygame Zero object for storing rectangular coordinates"
        ...
        _(  "actor.scale \nSet a scale of the Actor image."  ),
        _(  "actor.say_for_sec(text, second, fgcolor=None, bgcolor=None) \n\nActor imageining ustida qancha soniya davomida textni ko'rsatadi."  ),
    ]
}