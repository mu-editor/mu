...
STUDUINOBIT_APIS = [
    ...
    # buzzer
    _(
        "pystubit.board.buzzer.on(sound, duration=-1)\nPlay sound from the Buzzer at a pitch specified in 'sound'.\n'sound' can be set using strings ('C3'-'G9'), \nMIDI note numbers ('48'-'127') or frequencies (in integers).\nUse 'duration' to set the duration of the sound in milliseconds."
    ),
    _("pystubit.board.buzzer.off()\nStop any current sound output."),
    # temperature
    _(
        "pystubit.board.temperature.get_value()\nReturn Studuino:bit's temperature value(0-4095) in degrees Linear."
    ),
    _(
        "pystubit.board.temperature.get_celsius()\nReturn Studuino:bit's temperature in degrees Celcius."
    ),
    # lightsensor
    _(
        "pystubit.board.lightsensor.get_value()\nReturn Studuino:bit's light sensor's  value(0-4095) in linear."
    ),
    # accelerometer
    _(
        "pystubit.board.accelerometer.get_x()\nReturn Studuino:bit's tilt (X acceleration) in m/s/s's."
    ),
    _(
        "pystubit.board.accelerometer.get_y()\nReturn Studuino:bit's tilt (Y acceleration) in m/s/s's."
    ),
    _(
        "pystubit.board.accelerometer.get_z()\nReturn Studuino:bit's tilt (Z acceleration) in m/s/s's."
    ),
    _(
        "pystubit.board.accelerometer.get_values()\nGet the acceleration measurements in all axes at once, \nas a three-element tuple of integers (ordered as X, Y, Z)."
    ),
    _(
        "pystubit.board.accelerometer.set_fs(value)\nSet the sensor's maximum measurement.\nUse the string '2g', '4g', '8g', or '16g' to set the maximum\nvalue between 2G and 16G."
    ),
    _(
        "pystubit.board.accelerometer.set_sf(value)\nSet the sensor's units of measurement.\nIt can be set to 'mg' (mg units) or 'ms2' (m/s/s units)."
    ),
    # gyro
    _(
        "pystubit.board.gyro.get_x()\nReturn Studuino:bit's angular velocity on the X-axis in m/s/s's."
    ),
    _(
        "pystubit.board.gyro.get_y()\nReturn Studuino:bit's angular velocity on the Y-axis in m/s/s's."
    ),
    _(
        "pystubit.board.gyro.get_z()\nReturn Studuino:bit's angular velocity on the Z-axis in m/s/s's."
    ),
    _(
        "pystubit.board.gyro.get_values()\nGet the angular velocity in all axes at once,\nas a three-element tuple of integers (ordered as X, Y, Z)."
    ),
    _(
        "pystubit.board.gyro.set_fs(value)\nSet the sensor's maximum measurement.\nUse the string '250dps', '500dps', '1000dps', or '2000dps'\nto set the maximum value between 250 and 2000 degrees per second."
    ),
    _(
        "pystubit.board.gyro.set_sf(value)\nSet the sensor's units of measurement.\nIt can be set to 'dps' (degrees per second) or 'rps' (radians per second). "
    ),
    # compass
    _(
        "pystubit.board.compass.get_x()\nReturn magnetic field detected along Studuino:bit's X axis.\nThe compass returns the earth's magnetic field in micro-Tesla units.\nThe value will be higher facing magnetic north,\nand lower facing magnetic south."
    ),
    _(
        "pystubit.board.compass.get_y()\nReturn magnetic field detected along Studuino:bit's Y axis.\nThe compass returns the earth's magnetic field in micro-Tesla units.\nThe value will be higher facing magnetic north,\nand lower facing magnetic south."
    ),
    _(
        "pystubit.board.compass.get_z()\nReturn magnetic field detected along Studuino:bit's Z axis.\nThe compass returns the earth's magnetic field in micro-Tesla units.\nThe value will be higher facing magnetic north,\nand lower facing magnetic south."
    ),
    _(
        "pystubit.board.compass.get_values()\nGet the magnetic field measurements from all axes at once,\nas a three-element tuple of integers (ordered as X, Y, Z)."
    ),
    _(
        "pystubit.board.compass.calibrate()\nIf Studuino:bit's compass is confused, calibrate() it to adjust the its accuracy.\nCalibration will ask you to rotate the device to draw a circle on the display.\nAfterwards, Studuino:bit will know which way is north."
    ),
    _(
        "pystubit.board.compass.is_calibrated()\nIf Studuino:bit's compass is_calibrated() and adjusted for accuracy, return True.\nIf the compass hasn't been adjusted for accuracy, return False."
    ),
    _(
        "pystubit.board.compass.clear_calibration()\nReset Studuino:bit's compass using clear_calibration() command."
    ),
    _(
        "pystubit.board.compass.heading()\nReturn a number between 0-360 indicating the device's heading. 180 is north."
    ),
    # p0
    _(
        "pystubit.board.p0.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p0.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p0.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p0.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p0.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p0.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p0.status()\nDisplay current PWM usage on REPL."),
    _(
        "pystubit.board.p0.read_analog(mv=False)\nRead the voltage applied to pin. If mv=False, return the reading\nas a number between 0 (meaning 0v) and 4095. \nIf mv=True, return the reading in millivolts."
    ),
    # p1
    _(
        "pystubit.board.p1.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p1.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p1.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p1.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p1.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p1.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p1.status()\nDisplay current PWM usage on REPL."),
    _(
        "pystubit.board.p1.read_analog(mv=False)\nRead the voltage applied to pin. If mv=False, return the reading\nas a number between 0 (meaning 0v) and 4095. \nIf mv=True, return the reading in millivolts."
    ),
    # p2
    _(
        "pystubit.board.p2.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p2.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p2.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p2.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p2.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p2.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p2.status()\nDisplay current PWM usage on REPL."),
    _(
        "pystubit.board.p2.read_analog(mv=False)\nRead the voltage applied to pin. If mv=False, return the reading\nas a number between 0 (meaning 0v) and 4095. \nIf mv=True, return the reading in millivolts."
    ),
    # p3
    _(
        "pystubit.board.p3.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p3.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p3.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p3.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p3.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p3.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p3.status()\nDisplay current PWM usage on REPL."),
    _(
        "pystubit.board.p3.read_analog(mv=False)\nRead the voltage applied to pin. If mv=False, return the reading\nas a number between 0 (meaning 0v) and 4095. \nIf mv=True, return the reading in millivolts."
    ),
    # p4
    _(
        "pystubit.board.p4.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p4.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p4.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p4.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p4.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p4.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p4.status()\nDisplay current PWM usage on REPL."),
    # p5
    _(
        "pystubit.board.p5.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p5.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p5.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p5.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p5.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p5.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p5.status()\nDisplay current PWM usage on REPL."),
    _(
        "pystubit.board.p5.read_analog(mv=False)\nRead the voltage applied to pin. If mv=False, return the reading\nas a number between 0 (meaning 0v) and 4095. \nIf mv=True, return the reading in millivolts."
    ),
    # p6
    _(
        "pystubit.board.p6.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p6.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p6.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p6.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p6.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p6.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p6.status()\nDisplay current PWM usage on REPL."),
    # p7
    _(
        "pystubit.board.p7.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p7.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p7.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p7.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p7.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p7.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p7.status()\nDisplay current PWM usage on REPL."),
    # p8
    _(
        "pystubit.board.p8.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p8.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p8.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p8.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p8.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p8.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p8.status()\nDisplay current PWM usage on REPL."),
    _(
        "pystubit.board.p8.read_analog(mv=False)\nRead the voltage applied to pin. If mv=False, return the reading\nas a number between 0 (meaning 0v) and 4095. \nIf mv=True, return the reading in millivolts."
    ),
    # p9
    _(
        "pystubit.board.p9.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p9.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p9.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p9.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p9.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p9.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p9.status()\nDisplay current PWM usage on REPL."),
    _(
        "pystubit.board.p9.read_analog(mv=False)\nRead the voltage applied to pin. If mv=False, return the reading\nas a number between 0 (meaning 0v) and 4095. \nIf mv=True, return the reading in millivolts."
    ),
    # p10
    _(
        "pystubit.board.p10.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p10.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p10.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p10.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p10.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p10.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p10.status()\nDisplay current PWM usage on REPL."),
    # p11
    _(
        "pystubit.board.p11.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p11.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p11.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p11.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p11.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p11.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p11.status()\nDisplay current PWM usage on REPL."),
    # p12
    _(
        "pystubit.board.p12.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p12.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p12.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p12.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p12.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p12.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p12.status()\nDisplay current PWM usage on REPL."),
    # p13
    _(
        "pystubit.board.p13.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p13.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p13.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p13.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p13.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p13.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p13.status()\nDisplay current PWM usage on REPL."),
    # p14
    _(
        "pystubit.board.p14.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p14.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p14.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p14.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p14.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p14.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p14.status()\nDisplay current PWM usage on REPL."),
    # p15
    _(
        "pystubit.board.p15.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p15.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p15.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p15.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p15.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p15.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p15.status()\nDisplay current PWM usage on REPL."),
    # p16
    _(
        "pystubit.board.p16.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p16.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p16.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p16.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p16.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p16.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p16.status()\nDisplay current PWM usage on REPL."),
    _(
        "pystubit.board.p16.read_analog(mv=False)\nRead the voltage applied to pin. If mv=False, return the reading\nas a number between 0 (meaning 0v) and 4095. \nIf mv=True, return the reading in millivolts."
    ),
    # p19
    _(
        "pystubit.board.p19.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p19.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p19.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p19.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p19.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p19.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p19.status()\nDisplay current PWM usage on REPL."),
    # p20
    _(
        "pystubit.board.p20.write_digital(value)\nWrite digital output to a pin. Set pin to output high if value is 1, or to low, if it is 0."
    ),
    _(
        "pystubit.board.p20.read_digital()\nRead digital value from pin. The reading will be either 0 (low) or 1 (high)."
    ),
    _(
        "pystubit.board.p20.write_analog(value)\nOutput PWM signal. Set the output from 0 (0%) to 100 (100%)."
    ),
    _(
        "pystubit.board.p20.set_analog_period(period, timer=-1)\nSet the period of the PWM signal output to period milliseconds.\nThe minimum period is 1ms.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p20.set_analog_period_microseconds(period, timer=-1)\nSet the period of the PWM signal output to period microseconds.\nThe minimum period is 256us.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _(
        "pystubit.board.p20.set_analog_hz(hz, timer=-1)\nSet the period of the PWM signal output to period frequency.\nYou can set the PWM's timer by picking a timer ID 0-3."
    ),
    _("pystubit.board.p20.status()\nDisplay current PWM usage on REPL."),
    # DCMotor
    _(
        "pyatcrobo2.parts.DCMotor(pin)\nCreate a DC Motor instance. The pin parameter can be set\nto either 'M1' or 'M2' to specify a pin with a DC Motor connected to it."
    ),
    _("pyatcrobo2.parts.DCMotor.cw()\nSpin a DC Motor clockwise."),
    _("pyatcrobo2.parts.DCMotor.ccw()\nSpin a DC Motor counter-clockwise."),
    _(
        "pyatcrobo2.parts.DCMotor.stop()\nStop powering a DC Motor, allowing it to coast to a stop."
    ),
    _("pyatcrobo2.parts.DCMotor.brake()\nStop a DC Motor's rotation."),
    _(
        "pyatcrobo2.parts.DCMotor.power(power)\nSet a DC Motor's speed.\nThe speed can be set from 0 (slowest) to 255 (fastest)."
    ),
    # Servomotor
    _(
        "pyatcrobo2.parts.Servomotor(pin)\nCreate a Servomotor instance.\nThe pin parameter can be set to 'P13', 'P14', 'P15', or 'P16'\nto specify a pin with a Servomotor connected to it. "
    ),
    _(
        "pyatcrobo2.parts.Servomotor.set_angle(degree)\nSet a Servomotor's angle.\nThe angle can be sety in degrees 0-180."
    ),
    # Buzzer
    _(
        "pyatcrobo2.parts.Buzzer(pin)\nCreate a Buzzer instance.\nThe pin parameter can be set to 'P13', 'P14', 'P15', or 'P16'\nto specify a pin with a Buzzer connected to it. "
    ),
    _(
        "pyatcrobo2.parts.Buzzer.on(sound, volume=-1, duration=-1)\nSet a specific note for the Buzzer to play.\nThe note can be set using strings ('C3'-'G9'),\nMIDI note numbers ('48'-'127') or frequencies (in integers).\nThe volume can be set by percentage (0-99).\nDuration can be set in milliseconds to make the sound\nplay for a pre-set length of time."
    ),
    _("pyatcrobo2.parts.Buzzer.off()\nStop any current sound output."),
    # LED
    _(
        "pyatcrobo2.parts.LED(pin)\nCreate an LED instance.\nThe pin parameter can be set to 'P13', 'P14', 'P15', or 'P16'\nto specify a pin with an LED connected to it. "
    ),
    _("pyatcrobo2.parts.LED.on()\nTurn on an LED."),
    _("pyatcrobo2.parts.LED.off()\nTurn off an LED."),
    # IRPhotoReflector
    _(
        "pyatcrobo2.parts.IRPhotoReflector(pin)\nCreate an IR Photoreflector instance.\nThe pin parameter can be set to 'P0', 'P1', or 'P2'\nto specify a pin with an IR Photoreflector connected to it. "
    ),
    _(
        "pyatcrobo2.parts.IRPhotoReflector.get_value()\nRetrieve current sensor value (0-4095)."
    ),
    # LightSensor
    _(
        "pyatcrobo2.parts.LightSensor(pin)\nCreate a Light Sensor instance.\nThe pin parameter can be set to 'P0', 'P1', or 'P2'\nto specify a pin with a Light Sensor connected to it. "
    ),
    _(
        "pyatcrobo2.parts.LightSensor.get_value()\nRetrieve current sensor value (0-4095)."
    ),
    # Temperature
    _(
        "pyatcrobo2.parts.Temperature(pin)\nCreate a Temperature Sensor instance.\nThe pin parameter can be set to 'P0', 'P1', or 'P2'\nto specify a pin with a Temperature Sensor connected to it. "
    ),
    _(
        "pyatcrobo2.parts.Temperature.get_value()\nRetrieve current sensor value (0-4095)."
    ),
    _(
        "pyatcrobo2.parts.Temperature.get_celsius()\nRetrieve current sensor value in degrees Celsius."
    ),
    # SoundSensor
    _(
        "pyatcrobo2.parts.SoundSensor(pin)\nCreate a Sound Sensor instance.\nThe pin parameter can be set to 'P0', 'P1', or 'P2'\nto specify a pin with a Sound Sensor connected to it. "
    ),
    _(
        "pyatcrobo2.parts.SoundSensor.get_value()\nRetrieve current sensor value (0-4095)."
    ),
    # TouchSensor
    _(
        "pyatcrobo2.parts.TouchSensor(pin)\nCreate a Touch Sensor instance.\nThe pin parameter can be set to 'P0', 'P1', or 'P2'\nto specify a pin with a Touch Sensor connected to it. "
    ),
    _(
        "pyatcrobo2.parts.TouchSensor.get_value()\nRetrieve current sensor value (0/1)."
    ),
    # Accelerometer
    _(
        "pyatcrobo2.parts.Accelerometer(pin)\nCreate an Accelerometer instance.\nUse 'I2C' to set the Accelerometer's pin."
    ),
    _(
        "pyatcrobo2.parts.Accelerometer.configuration(highres, scale)\nChange the Accelerometer's settings.\nHigh res can be set to True (16-bit resolution) or False (8-bit resolution).\nThe Accelerometer's maximum measurable acceleration\ncan be set to 2, 4, or 8 (from 2G to 8G)."
    ),
    _(
        "pyatcrobo2.parts.Accelerometer.get_x()\nReturn tilt (X acceleration) in m/s/s's."
    ),
    _(
        "pyatcrobo2.parts.Accelerometer.get_y()\nReturn tilt (Y acceleration) in m/s/s's."
    ),
    _(
        "pyatcrobo2.parts.Accelerometer.get_z()\nReturn tilt (Z acceleration) in m/s/s's."
    ),
    _(
        "pyatcrobo2.parts.Accelerometer.get_values()\nGet the acceleration measurements in all axes at once, \nas a three-element tuple of integers (ordered as X, Y, Z)."
    ),
    # RNG
